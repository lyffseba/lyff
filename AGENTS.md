...
2. **Hub vs projects.** Meta docs/scripts live at the root. Nested dirs (`43/`, `bet/`, …) are **independent git repos** — commit inside the project that owns the change, not only at hub root unless changing hub files.
